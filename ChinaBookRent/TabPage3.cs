    ...
    partial class Form1
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < 20; ++i)
            {
                ...
                graphical.DrawString(reduceStr, new Font("黑体", 7.5f), b1, new PointF(50 * i + 70, 650));
                //小竖杠
                Pen penSmall = new Pen(Color.Black, 2);
                penSmall.EndCap = System.Drawing.Drawing2D.LineCap.Square;
                graphical.DrawLine(penSmall, new Point(50 * i + 100, 637), new Point(50 * i + 100, 640));
            }
            ...
            {
                if (i % 5 != 0) continue;
                Pen penSmall = new Pen(Color.Brown, 2);
                penSmall.EndCap = System.Drawing.Drawing2D.LineCap.Square;
            ...
            for (int i = 0; i < arrayRentData.Count; ++i)
            {
                ...
                Pen penSmall = new Pen(Color.IndianRed, 2);
                penSmall.EndCap = System.Drawing.Drawing2D.LineCap.Square;
                graphical.DrawLine(penSmall, new Point(50 * i + 100, 640 - System.Int16.Parse(arrayRentData[i].ToString()) * 6), new Point(50 * (i + 1) + 100, 640 - System.Int16.Parse(arrayRentData[i + 1].ToString()) * 6));
                //
                graphical.DrawEllipse(penSmall, 50 * i + 98, 639 - System.Int16.Parse(arrayRentData[i].ToString()) * 6, 3, 3);
            }
        }
    }
}
